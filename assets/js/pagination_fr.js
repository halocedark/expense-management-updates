...
SmoothPagination = function(parent, dataTarget, object)
{
	...
	this.isVisible = (object.isVisible == null) ? true : false;
	this.parent = parent;
	var page = 0;
	...
	links += '<li class="spnm-list-item"><a href="#" class="spnmli-nav-link" data-role="PAGE_LINK_FIRST">le première</a></li>';
	links += '<li class="spnm-list-item"><a href="#" class="spnmli-nav-link" data-role="PAGE_LINK_PREVIOUS">Précédent</a></li>';
	...
	links += '<li class="spnm-list-item"><a href="#" class="spnmli-nav-link" data-role="PAGE_LINK_NEXT">Suivant</a></li>';
	links += '<li class="spnm-list-item"><a href="#" class="spnmli-nav-link" data-role="PAGE_LINK_LAST">le dernier</a></li>';
	links += '</ul>';
